...
<div class="container" style="margin-top: 150px;">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i>Form Sewa Tempat Penyimpanan Barang</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('admin/proses_detailbarang_insert')?>" role="form" method="post">
            ...
            <?php } ?>
              ...
              <div class="box-body">
                <div class="form-group">
                  <label for="id_transaksi" style="align-content:center;">Silahkan isi form dibawah ini:</label>
 ...
 -->                <div class="form-group" style="margin-bottom:40px;">
                  <label for="nama_barang" style="margin-left:220px;display:inline;">Lokasi Asal</label>
                ...
                <div class="form-group" style="display:inline-block;">
                  <label for="kode_barang" style="width:87%;margin-left: 12px;">Jenis Barang</label>
