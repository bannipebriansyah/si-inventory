...
<head>
  ...
  <title>Si-Iventory | Table Jenis Barang</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?php echo base_url('admin') ?>" class="logo">
        ...
        <span class="logo-lg"><b>SI-</b>IVENTORY</span>
      </a>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="<?= base_url('admin/form_jenisbarang') ?>"><i class="fa fa-circle-o"></i> Tambah Jenis Barang</a></li>
            </ul>
          </li>
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="<?= base_url('admin/tabel_jenisbarang') ?>"><i class="fa fa-circle-o"></i> Tabel Jenis Barang</a></li>
            </ul>
          </li>
          <li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li>Tables</li>
          <li class="active"><a href="<?= base_url('admin/tabel_jenisbarang') ?>">Tabel Jenis Barang</a></li>
        </ol>
      </section>
          ...
          <div class="col-xs-12">
            ...
            <div class="box">
              ...
              <div class="box-body">
                ...
                <a href="<?= base_url('admin/form_jenisbarang') ?>" style="margin-bottom:10px;" type="button" class="btn btn-primary" name="tambah_data"><i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah Data</a>
                    ...
                    <tr>
                      <?php if (is_array($list_data)) { ?>
                        ...
                        <?php foreach ($list_data as $dd) : ?>
                          <td><?= $no ?></td>
                          <td><?= $dd->kode_jenisbarang ?></td>
                          <td><?= $dd->nama_jenisbarang ?></td>
                          <td><a type="button" class="btn btn-info" href="<?= base_url('admin/update_jenisbarang/' . $dd->id_jenisbarang) ?>" name="btn_update" style="margin:auto;"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                          <td><a type="button" class="btn btn-danger btn-delete" href="<?= base_url('admin/delete_jenisbarang/' . $dd->id_jenisbarang) ?>" name="btn_delete" style="margin:auto;"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                        </tr>
                        <?php $no++; ?>
                      <?php endforeach; ?>
                    <?php } else { ?>
