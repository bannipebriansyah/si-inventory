...
<head>
  ...
  <title>Si-Iventory | Edit Jenis Barang</title>
                  ...
                  <form action="<?= base_url('admin/proses_satuan_update') ?>" role="form" method="post">
                    ...
                    <div class="box-body">
                      <div class="form-group">
                        <?php foreach ($data_jenisbarang as $d) { ?>
                          <div class="box-body">
                            <div class="form-group" style="display:inline-block;">
                              <input type="hidden" name="id_jenisbarang" value="<?= $d->id_jenisbarang ?>">
                              <label for="kode_satuan" style="width:87%;margin-left: 12px;">Kode Jenis Barang</label>
                              <input type="text" required name="kode_jenisbarang" style="width: 90%;margin-right: 67px;margin-left: 11px;" class="form-control" id="kode_satuan" placeholder="Kode Jenis Barang" value="<?= $d->kode_jenisbarang ?>">
                            </div>
                            <div class="form-group" style="display:inline-block;">
                              <label for="nama_jenisbarang" style="width:73%;">Nama Jenis Barang</label>
                              <input type="text" required name="nama_jenisbarang" style="width:90%;margin-right: 67px;" class="form-control" id="nama_jenisbarang" placeholder="Nama Jenis Barang" value="<?= $d->nama_jenisbarang ?>">
                            </div>
                            <div class="form-group" style="display:inline-block;">
