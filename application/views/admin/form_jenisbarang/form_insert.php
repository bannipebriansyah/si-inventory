...
<head>
  ...
  <title>Si-Iventory | Jenis Barang</title>
...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?php echo base_url('admin') ?>" class="logo">
        ...
        <span class="logo-lg"><b>SI-</b>INVENTORY</span>
      </a>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class=""><a href="<?= base_url('admin/form_satuan') ?>"><i class="fa fa-circle-o"></i> Tambah Satuan Barang</a></li>
            ...
            <div class="container">
              ...
              <div class="box box-primary" style="width:94%;">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i> Tambah Jenis Barang</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <div class="container">
                  <form action="<?= base_url('admin/proses_jenisbarang_insert') ?>" role="form" method="post">
                    ...
                    <div class="box-body">
                      <div class="form-group" style="display:inline-block;">
                        <label for="kode_jenisbarang" style="width:87%;margin-left: 12px;">Kode Jenis Barang</label>
                        <input type="text" name="kode_jenisbarang" style="width: 90%;margin-right: 67px;margin-left: 11px;" class="form-control" id="kode_jenisbarang" placeholder="Kode jenisbarang">
                      </div>
                      <div class="form-group" style="display:inline-block;">
                        <label for="nama_jenisbarang" style="width:73%;">Nama Jenis Barang</label>
                        <input type="text" name="nama_jenisbarang" style="width:90%;margin-right: 67px;" class="form-control" id="nama_jenisbarang" placeholder="Nama jenisbarang">
                      </div>
                      <div class="form-group" style="display:inline-block;">
                      ...
                      <div class="box-footer" style="width:93%;">
                        ...
                        <a type="button" class="btn btn-info" style="width:15%;margin-right:19%" href="<?= base_url('admin/tabel_jenisbarang') ?>" name="btn_listsatuan"><i class="fa fa-table" aria-hidden="true"></i> Lihat Jenis Barang</a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?= date('Y') ?> PT - LEN Industri (Persero) </strong>
