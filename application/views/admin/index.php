...
<head>
  ...
  <title>Si-Iventory | Dashboard</title>
  ...
  <!-- Daterange picker -->
  <link rel="stylesheet" href=<?php echo base_url() ?>assets/web_admin/"bower_components/bootstrap-daterangepicker/daterangepicker.css"> <!-- bootstrap wysihtml5 - text editor -->
        ...
        <li class="treeview">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="<?php echo base_url('admin/form_jenisbarang') ?>"><i class="fa fa-circle-o"></i> Tambah Jenis Barang</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="<?php echo base_url('admin/form_satuan') ?>"><i class="fa fa-circle-o"></i> Tabel Jenis Barang</a></li>
            </ul>
